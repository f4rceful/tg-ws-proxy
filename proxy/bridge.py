...
class MsgSplitter:
    ...
    def split(self, chunk: bytes) -> List[bytes]:
        ...
        # Optimization: use an offset to avoid repeated O(N) `del` operations from the
        # beginning of the bytearrays, making parsing of large chunks with small packets O(N) instead of O(N^2).
